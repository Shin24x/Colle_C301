      ...
      <div class="col-xs-9 col-sm-7 col-md-5 col-lg-3 card" id="card-front"> 
        ...
        @if ($errors->any())
          ...
          <div class="mb-3 text-container">
            ...
            <input value="{{old('Email')}}" type="email" class="form-control" id="email" placeholder="Enter your email address" name="Email">
          </div>
          <div class="mb-3 text-container">
      ...
      <div class="col-xs-10 col-sm-7 col-md-5 col-lg-3 card" id="card-back"> 
        ...
        @if ($errors->any())
          ...
          <div class="mb-3 text-container">
            ...
            <input value="{{old('FullName')}}" type="text" class="form-control" id="fullname" placeholder="Enter your full name" name="FullName">
          </div>
          <div class="mb-3 text-container">
            <label for="email" class="form-label">Email Address</label>
            <input value="{{old('Email')}}" type="email" class="form-control" id="email" placeholder="Enter your email address" name="Email">
