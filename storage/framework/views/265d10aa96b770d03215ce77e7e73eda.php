...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/quiz.css')); ?>" />
  </head>
  <body>
  ...
  <div id="myModal" class="modal">
    <div class="modal-content">
      <p>    <a id="scoreDisplay"></a> <span class="close" onClick="closeModal()">Close</span></p>
              ...
              <!-- JavaScript -->
    <script src="<?php echo e(asset('assets/js/quiz.js')); ?>"></script>
    



    </body>
  </html><?php /**PATH C:\Users\pc\Documents\GitHub\Colle_C301\resources\views/quizzes/html/qhtmleasy.blade.php ENDPATH**/ ?>